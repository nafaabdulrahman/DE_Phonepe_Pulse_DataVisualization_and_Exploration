...
with t1:
    ...
    <h1 style="text-align: center; color: green;">
        <a href="" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: green;">
            ₹PhonePe Pulse  Analysis
        </a>
    </h1>
'''
    st.markdown(title_html, unsafe_allow_html=True)
    #title_link = '[PhonePe Pulse  Analysis]'
...
tr_map = pd.read_csv('https://raw.githubusercontent.com/nafaabdulrahman/phonpe-/main/tr_map.csv')
#++++++++++++++++++++++++++++++++++++
...
df1a = df1a.drop(3)._append(df1a.loc[3]).reset_index().drop('index',axis=1)
...
url2 = 'https://raw.githubusercontent.com/nafaabdulrahman/phonpe-/main/test.geojson'
